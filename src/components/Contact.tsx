...
const Contact = () => {
  return (
    ...
    <section className="min-h-screen flex items-stretch text-white bg-gray-200">
        <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center bg-[url('https://images.pexels.com/photos/323503/pexels-photo-323503.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')]" >
            ...
            <div className="w-full px-24 z-10">
                <h1 className="text-5xl font-bold text-left tracking-wide">Contáctenos</h1>
                <p className="text-3xl my-4">Deje que sus ideas vuelen a todas partes del mundo!</p>
            </div>
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" >
            <div className="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center bg-[url('https://images.pexels.com/photos/323503/pexels-photo-323503.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')]" >
                <div className="absolute bg-black opacity-60 inset-0 z-0"></div>
            </div>
