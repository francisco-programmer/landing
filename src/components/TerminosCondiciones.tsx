...
const TerminosCondiciones = () => {
  const stilos = "text-gray-900 font-poppins "
  const subtitulos = "text-gray-900 font-poppins font-bold"
  return (
    <div className=" bg-gray-200 sm:px-60 px-5 sm:py-10 py-5">
      <div className="bg-white shadow-2xl rounded-xl p-5">
        <div className="flex flex-col gap-5">
          ...
          <br></br>
          <br></br>
          <p className={subtitulos}>INFORMACION RELEVANTE</p>
          <p className={stilos}>
          ...
          <p className={stilos}>
            ...
            nuestros productos. https://www.axiosagency.info/ no asume la
          ...
          <p className={subtitulos}>LICENCIA</p>
          <p className={stilos}>
            Axios Studio a través de su sitio web concede una licencia para que
          ...
          <p className={subtitulos}>USO NO AUTORIZADO</p>
          <p className={stilos}>
          ...
          <p className={subtitulos}>PROPIEDAD</p>
          <p className={stilos}>
          ...
          <p className={subtitulos}>POLÍTICA DE REEMBOLSO Y GARANTÍA</p>
          <p className={stilos}>
            ...
            sido usado correctamente. Esto incluye:
          </p>
          <p className={stilos}>
            – De acuerdo a las especificaciones técnicas indicadas para cada
            producto.<br></br>– En condiciones ambientales acorde con las
            especificaciones indicadas por el fabricante.<br></br>– En uso
            específico para la función con que fue diseñado de fábrica.<br></br>
            – En condiciones de operación eléctricas acorde con las
            especificaciones y tolerancias indicadas.
          </p>
          <p className={subtitulos}>COMPROBACIÓN ANTIFRAUDE</p>
          <p className={stilos}>
          ...
          <p className={subtitulos}>PRIVACIDAD</p>
          <p className={stilos}>
            Este https://www.axiosagency.info/ garantiza que la valencia cf
            noticias información personal que usted envía cuenta con la
            seguridad necesaria. Los datos ingresados por usuario o en el caso
            de requerir una validación de los pedidos no serán entregados a
          ...
          <p className={stilos}>
            Axios Studio reserva los derechos de cambiar o de modificar estos
